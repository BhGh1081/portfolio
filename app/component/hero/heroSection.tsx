...
export default function HeroSection() {
    ...
    return (
        <div className="md:h-[60%] flex flex-col flex-col-reverse gap-20 md:flex-row justify-between bg-black/60 rounded-[15px] md:p-10 p-5">
            <div className="md:w-[60%] flex flex-col justify-between">
                <article className="mb-10 flex flex-col items-center text-center md:items-start text-start">
                    ...
                    <h2 className="text-[1.2rem] mb-10 flex sm:items-center gap-2">
